...
OUTPUT = ROOT / "assets" / "Liu-Jingchen-Academic-Resume-2026-v5.pdf"
...
activity_details = [
    ...
    ("乡村振兴实践", "参与湖南湘乡乡村振兴工作站实践，了解基层项目运行，协助开展调研与实践活动。<b>该实践获实践金奖。</b>"),
    ("志愿服务", "参加“音禾计划”听障儿童志愿服务，协助开展儿童陪伴与活动支持。<b>项目获评五星级志愿项目。</b>"),
]
