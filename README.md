...
- `assets/Liu-Jingchen-Academic-Resume-2026-v12.pdf`：网站当前提供下载的一页现代双栏中文学术简历
...
联系导师版简历的内容维护在 `tools/academic_resume_data.json`，更新后运行 `tools/generate_modern_resume_preview.py` 生成最新版 PDF。
